  ...
  async function handleSaveService(e) {
    ...
    try {
      ...
      const body = editingService 
        ? { ...serviceForm, serviceId: editingService.id }
        : serviceForm;
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr style={{ background: '#f9f9f9', borderBottom: '2px solid #e0e0e0' }}>
                      ...
                      <th style={{ padding: '1rem', textAlign: 'center', fontWeight: '600' }}>Sedan</th>
                      <th style={{ padding: '1rem', textAlign: 'center', fontWeight: '600' }}>SUV</th>
                      <th style={{ padding: '1rem', textAlign: 'center', fontWeight: '600' }}>Truck</th>
                      <th style={{ padding: '1rem', textAlign: 'center', fontWeight: '600' }}>Matatu</th>
